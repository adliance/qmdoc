...
This partial provides the same content across languages. This is the default (English) version, used whenever no translated version exists for the current document's language.
